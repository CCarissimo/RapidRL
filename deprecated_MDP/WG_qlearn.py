        ...
        if Learn:
            if buffer.mem_cntr > batch_size:
                ...
                for index in range(batch_size):
                    ...
                    q_table[str(state)][action] = q_table[str(state)][action] + alpha * (rewards[index] +
                                                                                         gamma * max(
                                v for v in q_table[str(state)].values()) - q_table[str(state)][action])
